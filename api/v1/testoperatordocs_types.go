...
type TestOperatorDocsSpec struct {
...
type TestOperatorDocsStatus struct {
...
type TestOperatorDocs struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   TestOperatorDocsSpec   `json:"spec,omitempty"`
	Status TestOperatorDocsStatus `json:"status,omitempty"`
}

//+kubebuilder:object:root=true

// TestOperatorDocsList contains a list of TestOperatorDocs
type TestOperatorDocsList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []TestOperatorDocs `json:"items"`
}

func init() {
	SchemeBuilder.Register(&TestOperatorDocs{}, &TestOperatorDocsList{})
}
